      ...
      <div className={styles.mainContent}>
        <div className={styles.headerContent}>
          ...
          <div className="right-header">
            <h2 className="name">
              {dataJson.home.desc_myself}
              <span className={styles.name}>Guibane Mohamed Hedi</span>.{" "}
              {dataJson.home.job}.
            </h2>
            <p>
              {dataJson.home.desc_detailed_part1}.<br />
              {dataJson.home.desc_detailed_part2}.
            </p>
            <button className={styles.mainbtn}>Download CV</button>
          </div>
        </div>
        <div className={styles.skills}>
          ...
          <ul>
            <li>
              Backend and frontend development of websites and web applications.
            </li>
            <li>
              Maintenance, bug fixing and improvement of web sites or
              applications.
            </li>
            <li>
              Set up various unit, end to end, regression und vulnerability
              tests
            </li>
        ...
        <div className={styles.skills}>
          ...
          <ul>
            ...
            <li>
              Languages and frameworks( Vanilla Js, nextJs, React, ReactNative,
              Flask, Flutter...)
            </li>
            <li>
              use outils to implement unit test with postMan or use frameworks
              of Test(pytest, jtest, ...)
            </li>
            <li>
              Continuous integration and deployment tools (Jenkins, GitLab,
              Docker)
            </li>
